    ...
    public class TouristAreaController : Controller
    {
        ...
        public async Task<IActionResult> DetailTouristArea([FromBody] TouristAreaDetailRequest req)
        {
            ...
            if (req.TourismProduct == null)
            {
                ...
                // Nếu nó lọt vào đây, chắc chắn 100% Frontend Axios đang gửi sai JSON format
                return BadRequest("Đối tượng TourismProduct bị null. Hãy check lại chữ hoa/chữ thường trong JSON!");
            }
